        ...
        <div className="flex w-1/5 flex-col bg-zinc-900 bg-opacity-95 text-white text-xl font-semibold shadow-lg">
            <div className="flex-1 overflow-y-auto">
                <ul className="flex flex-col py-4 justify-center space-y-1">
                    ...
                    {user.username === "admin" &&                     <li><a className="flex items-center px-6 py-3 hover:bg-sky-500 hover:bg-opacity-25" href="/users"><span className="mdi mdi-account-multiple mr-3"></span>Kelola User</a></li>}
