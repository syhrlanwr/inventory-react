    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                <div className="text-xl"> <a className="hover:bg-sky-600 bg-sky-500 text-white px-4 py-2 rounded-lg font-medium" href="/rak/add"><span className="mdi mdi-text-box-plus mr-2"></span>Tambah Rak</a></div>
